...
export function App() {
  ...
  return (
    <main className="app-shell">
      <header className="topbar"><div className="brand"><span className="brand-mark"><GitBranch size={17} /></span><span>branchline</span><span className="eyebrow">WORKFLOW STUDIO</span></div><div className="topbar-actions"><span className="status-dot" />Inngest connected <Button size="sm" variant="ghost"><Settings2 size={15} /> Settings</Button></div></header>
