...
Assignments from the FlyRank internship backend track. Each assignment lives in
its own folder with its own code, README, and stage history.
...
| `A4-auth-login-and-protect` (4) | 4 | Supabase Auth: login, JWT verification, protected routes |
